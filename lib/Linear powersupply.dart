...
class Linearpowersupply extends StatefulWidget {
  @override
  State createState()=>new LinearpowersupplyState();
}
class LinearpowersupplyState extends State<Linearpowersupply>{
//drop down list
  ...
  String selectAssociation="Linear Power Supply";
//drop down list
  @override
