...
class src1 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _src1State createState() => _src1State();
}

class _src1State extends State<src1> {
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1fksBk18fEPdcLVAaZTJqnjMd26a0oBsn/view?usp=sharing",
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1u-wLnoTopv69QVHmo_LIFC9vJDWzG8e_/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 528.6 KB)'),
                ),
              ],
            ),
