...
class a18 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _a18State createState() => _a18State();
}

class _a18State extends State<a18> {
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1WVNucLfJGKdfIxt6s0bRJ2CEZxHvL5YI/view?usp=sharing",
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1i7aeI0MQg7wTFOdc24K-O4dH67Zx_2wQ/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.JPG FILE 150.8 KB)'),
                ),
              ],
            ),
