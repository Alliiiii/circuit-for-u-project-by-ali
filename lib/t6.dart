...
class t6 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _t6State createState() => _t6State();
}

class _t6State extends State<t6> {
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('Short Circuit Detection',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/t6.gif',fit:BoxFit.cover)),
            Column(
              ...
              children: <Widget>[
                ...
                TextButton(
                  child: Padding(
                    ...
                    child: const Text('                                                                            2020-04-19',style:TextStyle(fontSize:14.0,color:Colors.black54,fontStyle:FontStyle.italic)),
                  ),
                  onPressed: () {
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1yyeOv6VGiz4OStspkNljKtI-gLVf7_Mb/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:79.8 KB)'),
                ),
              ],
            ),
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1SZqtPXmzxWfBndyTpjuNCPt7g0R0L1za/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.ZIP FILE SIZE:52 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 50.9 KB)'),
                ),
              ],
            ),
