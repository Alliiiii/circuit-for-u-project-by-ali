...
class lg7 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _lg7State createState() => _lg7State();
}

class _lg7State extends State<lg7> {
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1Bnf9-KSjH5JJtj2aaPTDTgrBXoST2H6E/view?usp=sharing",
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1MjFERCOfniSCpXt8heiJALc1WDkxIVOX/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 42.1 KB)'),
                ),
              ],
            ),
