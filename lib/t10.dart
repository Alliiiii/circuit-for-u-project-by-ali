...
class t10 extends StatefulWidget {
  ...
  @override
  _t10State createState() => _t10State();
}
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('Single Bidirectional Buffer and Level Shift',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/t10.gif',fit:BoxFit.cover)),
            Column(
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1RelToOZbWv14Cv09mZgJuQM3jB1Db_XD/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:61.5 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 68.8 KB)'),
                ),
              ],
            ),
