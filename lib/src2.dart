...
class src2 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _src2State createState() => _src2State();
}

class _src2State extends State<src2> {
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('SCR Test Circuit ',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/scr2.png',fit:BoxFit.cover)),
            Column(
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1YMSkxHk91Q8J4GIr8Tz4E9NpBAMttGq0/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:64.9 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.PNG FILE 68 KB)'),
                ),
              ],
            ),
