...
class eighty2 extends StatefulWidget {
  @override
  _eighty2State createState() => _eighty2State();
}

class _eighty2State extends State<eighty2> {
...
//class eighty2 extends StatelessWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text(' External Interrupt for AT89C51',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.20,
                width: width*0.70,
                child: Image.asset('assets/82.gif',fit:BoxFit.cover)),
            Column(
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                   ...
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1qToMwwATLmhlCEA7PG1dxFYfZI9k2iRg/view?usp=sharing", 
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:73.3 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1kUKZfXsOSBIKi1LdqehuIcMJjN_D0Ugf/view?usp=sharing", 
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.RAR FILE SIZE:69 KB)'),
                ),
              ],
            ),
