...
class op3 extends StatefulWidget {
  ...
  @override
  _op3State createState() => _op3State();
}
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1-_c0_t5lpT_72sOPNSksV1J7iZrjiGtc/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.ZIP FILE SIZE:44.8 KB)'),
                ),
              ],
            ),
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1Q9qetkSkyoaJko7z-71SmYWh5hacrEwh/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
