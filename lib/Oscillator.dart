...
class Oscillators extends StatefulWidget {
  @override
  State createState()=>new OscillatorsState();
}
class OscillatorsState extends State<Oscillators>{
//drop down list
  ...
  String selectAssociation="Oscillators";
//drop down list
  @override
