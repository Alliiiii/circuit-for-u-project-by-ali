...
class bc18 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _bc18State createState() => _bc18State();
}

class _bc18State extends State<bc18> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
                height: height * 0.40,
                width: width * 0.95,
                child: Image.asset('assets/bc18.JPG', fit: BoxFit.cover)),
            Column(
