...
class dc1 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _dc1State createState() => _dc1State();
}

class _dc1State extends State<dc1> {
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1oWf_6DS-5eMh2cC_A0DIuO-IC8e_KSg4/view?usp=sharing",
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1pcdsGgVWBylLddskNB19Hvo9R6p4cjkj/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 63.6 KB)'),
                ),
              ],
            ),
