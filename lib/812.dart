...
class eighty812 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _eighty812State createState() => _eighty812State();
}

class _eighty812State extends State<eighty812> {
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('LED Blinking Test',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.20,
                width: width*0.70,
                child: Image.asset('assets/812.gif',fit:BoxFit.cover)),
            Column(
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                   ...
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1JI_4o7WQhwGGtxDVTbtxeNF2CxzcmsPe/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:80.5 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1hSgrLW3gOuRnN8qsDsptRYurTIL66Xye/view?usp=sharing",
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.HEX FILE SIZE:641 B)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1c8_tSr9M7YAq2tvaxWOOS0IU3kvEXxWI/view?usp=sharing",
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOADE PROGRAM FILE'),
                ),
              ],
            ),
            //Source File code
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/11TmHTDgLI9ja4PXBH4SZXRZzwYkJXWnA/view?usp=sharing",
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.RAR FILE SIZE:256 B)'),
                ),
              ],
            ),
