...
class ElectricalCircuits extends StatefulWidget {
@override
State createState()=>new ElectricalCircuitsState();
}
class ElectricalCircuitsState extends State<ElectricalCircuits>{
//drop down list
...
String selectAssociation="Electrical Circuits";
//drop down list
@override
