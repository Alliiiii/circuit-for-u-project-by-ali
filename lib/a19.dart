...
class a19 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _a19State createState() => _a19State();
}

class _a19State extends State<a19> {
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('LDR with Operational Amplifier',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/a19.JPG',fit:BoxFit.cover)),
            Column(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1iXmCcdxGX5GnTSA4GFEk0s-Ng4Rne--N/view?usp=sharing",
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.JPG FILE 109.4 KB)'),
                ),
              ],
            ),
