...
class switchmodepowersupply extends StatefulWidget {
  @override
  State createState()=>new switchmodepowersupplyState();
}
class switchmodepowersupplyState extends State<switchmodepowersupply>{
//drop down list
  ...
  String selectAssociation="Switch Mode Power Supplies";
//drop down list
  @override
