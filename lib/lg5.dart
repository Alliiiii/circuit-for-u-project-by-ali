...
class lg5 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _lg5State createState() => _lg5State();
}

class _lg5State extends State<lg5> {
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('Two Input NOR',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/lg5.gif',fit:BoxFit.cover)),
            Column(
              ...
              children: <Widget>[
                ...
                TextButton(
                  child: Padding(
                    ...
                    child: const Text('                                                                            2020-06-07',style:TextStyle(fontSize:14.0,color:Colors.black54,fontStyle:FontStyle.italic)),
                  ),
                  onPressed: () {
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1c2UGpMmnh04TE1TtnK7uk-JX2n5KvwZe/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:27.1 KB)'),
                ),
              ],
            ),
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1xybGTH2KyR0oLZcKVBKmNEoeSRxYJoS_/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.RAR FILE SIZE:44.2 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 39.9 KB)'),
                ),
              ],
            ),
