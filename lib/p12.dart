    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('Two Channel FDTI FT2232 USB to UART Converter',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/p12.JPG',fit:BoxFit.cover)),
            Column(
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1fGVPlKbaJngVhe0YGiYHSkri0UqZKYbv/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.PDF FILE SIZE:54 KB)'),
                ),
              ],
            ),
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1mO1LMfBQk8f873ondXP8rU3lWxrEKiOU/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.PCBDOC FILE SIZE:907 KB)'),
                ),
              ],
            ),
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1D7_6aSdIKN-kjEJNgRDksN0UllQywKCT/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD RAR FILE SIZE:3.1 MB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.JPG FILE 86.2 KB)'),
                ),
              ],
            ),
