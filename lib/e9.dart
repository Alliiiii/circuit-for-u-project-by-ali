    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('Example Code for LCD 20x4',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.55,
                width: width*0.95,
                child: Image.asset('assets/e9.JPG',fit:BoxFit.cover)),
            Column(
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1_EipUz3Rrnh4nraWWb-Xtm42nvud0fih/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.PDSPRJ FILE SIZE:14.5 KB)'),
                ),
              ],
            ),
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1ZBOHJ9xtsCDw0sB5c_MhyWSYBhIja5gt/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD RAR FILE SIZE:158.2 MB)'),
                ),
              ],
            ),
