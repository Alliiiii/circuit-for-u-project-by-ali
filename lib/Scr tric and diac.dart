...
class Srctricanddiac extends StatefulWidget {
  @override
  State createState()=>new SrctricanddiacState();
}
class SrctricanddiacState extends State<Srctricanddiac>{
//drop down list
  ...
  String selectAssociation="SCR TRIAC & DIAC";
//drop down list
  @override
