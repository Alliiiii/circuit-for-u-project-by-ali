...
class eighty811 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _eighty811State createState() => _eighty811State();
}

class _eighty811State extends State<eighty811> {
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('Basic Calculator for Beginners',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.20,
                width: width*0.70,
                child: Image.asset('assets/811.jpg',fit:BoxFit.cover)),
            Column(
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                   ...
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1s9ppWT2iFCLptVovBM128zIeQY2X1F3q/view?usp=sharing",
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1I36Tw2Loma3y2WA0V_6IQX-YlNYrYoPm/view?usp=sharing",
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.HEX FILE SIZE:5.6 KB)'),
                ),
              ],
            ),
            //Source File code
              ...
              children: <Widget>[
                RaisedButton(
                 ...
                 onPressed: ()async{
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1clHCt776JLbL8H1La1Z_SiLiwBvwCsm-/view?usp=sharing",
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.RAR FILE SIZE:85.7 KB)'),
                ),
              ],
            ),
