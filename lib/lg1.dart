...
class lg1 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _lg1State createState() => _lg1State();
}

class _lg1State extends State<lg1> {
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1zaf6NtOqfZ09IIG34EQWjzPWU6SL_YOa/view?usp=sharing",
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1ldyODtk9FBrA7SyzqAXWpuPZgLzWJv8s/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 43.2 KB)'),
                ),
              ],
            ),
