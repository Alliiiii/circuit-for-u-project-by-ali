...
class op4 extends StatefulWidget {
  ...
  @override
  _op4State createState() => _op4State();
}
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child:Row(children: [
                Text("Operational Amplifie",style:TextStyle(/*fontSize:14.0,*/color: Colors.grey[600],fontStyle: FontStyle.italic)),
              ],
              ),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/op4.gif',fit:BoxFit.cover)),
            Column(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1JQaIy32ksi4Af_eJagx7SyUKYa6M7l9L/view?usp=sharing",
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1Xz73W-1McjZMO7KjZ79CwDPOKIZymnys/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 69.4 KB)'),
                ),
              ],
            ),
