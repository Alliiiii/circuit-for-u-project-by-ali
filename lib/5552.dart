...
class triplefive2 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _triplefive2State createState() => _triplefive2State();
}

class _triplefive2State extends State<triplefive2> {
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('Bistable Multivirator Using 555 Timmer',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/5552.gif',fit:BoxFit.cover)),
            Column(
            ...
            Container(
              ...
              child:Text("This circuit is designed and simulated in Proteus 7.10. In this circuit you will learn about the famous timer ic which is NE555. Many companies make this IC and there prefix can be changed but number will be 555, for example Texas Instruments make this IC with name LM555. Functionality will be same of both the IC's. So manufacturer doesn't matter unless the functionality is same. The 555 timer IC can be used in all multivibrator mode. It can be used as\n"
                  ...
                  "In this circuit 555 timer IC is used as bistable multivibrator mode. The astable and monostable mode was added previously. Come back daily to get new circuit.\n"
                  "The working of this circuit is given below.\n"
                  "1. Bistable mode means there will be two stable levels and none is unstable level at the output. The circuit maintains its output untill external trigger applies.\n"
                  "2. The operating range of 555 timer IC is +5Vdc to 18Vdc.\n"
                  "3. No RC time (product of C2 and R1) is used, because we want stable states. The only external trigger changes output and that output will remain unchanged untill next trigger comes.\n"
                  "4. The trigger pin is active low (1/3 of Vcc) and it will trigger the output at low or negative pulse.\n"
                  "5. In this circuit the trigger pin is connected with pin 6 and also connected with output through resistor R5 of 10Kohm and a push button, a capacitor C2 of 100nF is placed between ground and common point of R5 and push button to give a trigger pulse.\n"
                  "Applications:\n"
                  "1. This circuit is used to understand how bistable multivibrator works.\n"
                  "2. This circuit can be used to manually change the output levels.\n"
                  "Download these files to perform more experiments.\n"
                  "New circuits are added daily, so come back daily to get new amazing circuits.\n",style: TextStyle(color: Colors.grey[600]),),
            ),
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                   ...
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1h9s9bTBdgePH5TaLdelqLw2Rsrr1Vb7D/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:77.2 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1kBqKS21bVKpR1GAZ-k7VCDs6loK4lc5h/view?usp=sharing",
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.ZIP FILE SIZE:46.1 KB)'),
                ),
              ],
            ),
            //Source File code
