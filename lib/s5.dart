    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('PIC12F675 Zeta Buck Boost Converter',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.25,
                width: width*0.95,
                child: Image.asset('assets/s5.gif',fit:BoxFit.cover)),
            Column(
              ...
              children: <Widget>[
                ...
                TextButton(
                  child: Padding(
                    ...
                    child: const Text('                                                                            2020-05-20',style:TextStyle(fontSize:14.0,color:Colors.black54,fontStyle:FontStyle.italic)),
                  ),
                  onPressed: () {
            ...
            Container(
              ...
              child:Text('This circuit is simulated in Proteus 7.10. While code is written in MpLab X IDE using XC8 compiler. The microcontroller used in this project is PIC12F675. A zeta buck boost (step up and step down) converter is made by generating PWM through microcontroller. The working of this project is given below.\n'
                  ...
                  '2. In this circuit, a non-zeta buck boost converter called zeta converter is made using PIC12F675.\n'
                  '3. The output voltage Vo formula for zeta converter is\n'
                  '   Vo = D*Vin/(1-D)\n'
                  ...
                  '5. The input voltage of zeta buck boost converter is 12V, and output voltage can be lower or greater than 12V depending on duty cycle.\n'
                  ...
                  '10. The frequency can also be changed by changing RV2.\n'
                  ...
                  '15. When the mosfet Q1 is ON, it connects the inductor L1 to +12Vdc, and inductor is charged and stores electrical energy in the form of current (i.e (1/2)*L*I^2), the capacitor C4 and inductor L2 also charges and the inductor L2 provides output current Io.\n'
                  '16. When the mosfet Q1 is OFF, both inductors releases its energy, L1 uses C4 and completes it path through diode D1, and inductor energy is added to the output voltage (as inductor tries to maintain its current direction). The inductor L2 again provides output current Io.\n'
                  '17. The current direction can be seen using arrows and colors.\n'
                  '18. The diode D1 is used to make the close loop for inductors to release its energy (when the mosfet is OFF) to output voltage.\n'
                  'Application:\n'
                  '1. This circuit can be used to understand the concept of an zeta buck boost converter.\n'
                  '2. This circuit can be used as variable step-down and step up or zeta buck boost converter for DC input.\n'
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      ...
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1qLxbnZUz1ifzU-aS1noeJ32PvR3gyoyK/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:103.2 KB)'),
                ),
              ],
            ),
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1jvRa5zT-p7MlsYduA39OuJp-svlyrhgD/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/drive/folders/1kXd4GriiLrVHNjUApRmYyhl9PxTV5ZNr?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (status.isGranted) {
                      final externalDir = await getExternalStorageDirectory();
                      await FlutterDownloader.enqueue(
                        url: "https://drive.google.com/file/d/1lfYZONYU2DcDSAyHCUyBi-vkOeWheGVc/view?usp=sharing",
                        savedDir: externalDir.path,
                        fileName: "download",
                        showNotification: true,
                        openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD ZIP FILE SIZE:546.2 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.GIF FILE 588.9 KB)'),
                ),
              ],
            ),
