...
class eighty3 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _eighty3State createState() => _eighty3State();
}

class _eighty3State extends State<eighty3> {
    ...
    Widget showdescription=Container(
      ...
      child:Card(
        child: Column(
          ...
          children: <Widget>[
            Text('Two Digit Counter Program 00-99',style:TextStyle(fontSize:19.0,fontWeight:FontWeight.bold,)),
            ...
            Container(
                height:height*0.20,
                width: width*0.70,
                child: Image.asset('assets/83.gif',fit:BoxFit.cover)),
            Column(
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                   ...
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1zeyT1zhBgC8WQRKBQ2FTwQvSe4teHycl/view?usp=sharing",
                  ...
                  child: Text('DOWNLOAD(.DSN FILE SIZE:76.6 KB)'),
                ),
              ],
            ),
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1LVKTcoPOtt8TUQnd83gKtcqfkg4wRQGW/view?usp=sharing",
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1DwTaw0qc7dAFXyMkbpQAW8mDThXM5ITw/view?usp=sharing",
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
                  ...
                  color: Colors.orange,
                  padding: const EdgeInsets.all(8.0),
                  child: Text('DOWNLOAD(.RAR FILE SIZE:95.7 KB)'),
                ),
              ],
            ),
