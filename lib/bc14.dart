...
class bc14 extends StatefulWidget {
  //MyStatelessWidget({Key key}) : super(key: key);
  @override
  _bc14State createState() => _bc14State();
}

class _bc14State extends State<bc14> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
                height: height * 0.40,
                width: width * 0.95,
                child: Image.asset('assets/bc14.JPG', fit: BoxFit.cover)),
            Column(
